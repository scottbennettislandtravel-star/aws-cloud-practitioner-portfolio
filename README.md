# ☁️ AWS Cloud Portfolio – Scott Bennett

Welcome to my AWS Cloud Portfolio.

This repository documents my hands-on journey from foundational AWS concepts to real-world cloud architecture, with the goal of becoming an AWS Solutions Architect.
...
5. Networking (VPC + Private Access)  
...
- Removal of unnecessary public access  
- Secure key-based EC2 access  
